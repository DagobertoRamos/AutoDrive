...
export const SITE_SERVICES = [
  ...
  { key: 'vendaSeuCarro', label: 'Venda seu carro', path: '/venda-seu-carro', default: false, locked: false, available: false, hint: 'O cliente envia o carro dele para avaliação.' },
