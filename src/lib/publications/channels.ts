...
export const CHANNELS: ChannelSpec[] = [
  ...
  evaluating('MOBIAUTO', 'Mobiauto', ['mobiauto', 'mobiauto.com.br', 'mobigestor'], 'Integração de estoque por API exige autorização da Mobiauto (swagger de teste citado: test-open-api.mobiauto.com.br). Prioritário para expansão.', 'https://ajuda.revendamais.com.br/pt-BR/articles/7892670-integrador-adicionar-mobiauto-para-integracao-de-estoque', 11),
  evaluating('NAPISTA', 'NaPista', ['napista', 'napista.com.br', 'na pista'], 'Integradores de mercado anunciam no NaPista; documentação/credenciais não públicas. Solicitar ao portal.', 'https://ajuda.revendamais.com.br/pt-BR/collections/199048-integrador', 12),
  ...
  evaluating('USADOSBR', 'Usadosbr', ['usadosbr', 'usados br', 'usadosbr.com'], 'Conector adicional, conforme condições do portal.', 'https://www.usadosbr.com', 16),
