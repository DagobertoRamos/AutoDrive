...
export const NAV_GROUPS: NavItem[] = [
  ...
  // ── PENDÊNCIAS ────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { label: 'Penalidades de Pendências', href: '/pendencias/penalidades',          icon: ShieldAlert,   module: 'pendencies.manage' },
      { label: 'Vendedor',                  href: '/pendencias/vendedor',             icon: UserSquare,    module: 'pendencies' },
      { label: 'Configurações',             href: '/pendencias/configuracoes/gerais', icon: Settings,      module: 'pendencies.settings' },
    ],
  },
  ...
  // ── SITE DA LOJA ──────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { label: 'Financiamentos',        href: '/site/financiamentos', icon: CircleDollarSign, module: 'site' },
